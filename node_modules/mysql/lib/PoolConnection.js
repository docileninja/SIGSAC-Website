...
PoolConnection.prototype.end = function () {
  console.warn( 'Calling pool.end() to release a pooled connection is '
              + 'deprecated. In next version calling pool.end() will be '
              + 'restored to default pool.end() behavior. Use '
              + 'pool.release() instead.'
              );
  this.release();
};
